...
/* USER CODE BEGIN PV */
char left_code[8]; // 电机1编码器值
char right_code[8]; // 电机2编码器值
unsigned int MotorSpeed1;  // 电机当前速度数值，从编码器中获取  电机1
unsigned int MotorSpeed2;  // 电机2
int Direction1;		  // 电机输出     电机1
int Direction2;     // 电机输出     电机2
...
//	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12, 0);
		...
		HAL_TIM_Encoder_Start(&htim4, TIM_CHANNEL_1 | TIM_CHANNEL_2); // 开启编码器A和B
		HAL_TIM_Encoder_Start(&htim5, TIM_CHANNEL_1 | TIM_CHANNEL_2); // 开启编码器C和D
		motor_advance(&htim1, TIM_CHANNEL_1, TIM_CHANNEL_2, 17);  // 驱动电机1
		motor_advance(&htim1, TIM_CHANNEL_3, TIM_CHANNEL_4, 17);  // 驱动电机2
